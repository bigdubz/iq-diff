...
for file_name in os.listdir(folder_path):
    if file_name.endswith(".c"):
        ...
        with open(file_path, 'r') as file:
            ...
            # Make a secondary check to sanitize the array "comments with digits" and remove duplicates as well as invalid numbers
            ...
            # If there is still more than one number in the array, create a popup that tells the user to check that there is only one student id in the file
